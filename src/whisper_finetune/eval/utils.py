...
# Arabic: preserve script; no Latin char filter. char_vocab=None => skip vocab filter in normalize_text.
VOCAB_SPECS_ARABIC = {
    "char_vocab": None,
    "char_lookup": {},  # optional: normalize alef variants, tatweel, etc.
...
VOCAB_SPECS = {
    ...
    "arabic": VOCAB_SPECS_ARABIC,
}


def normalize_text(
    text: str,
    char_vocab: Optional[Set[str]],
    ...
    # If char_vocab is None (e.g. VOCAB_SPECS["arabic"]), do not filter; preserve script.
